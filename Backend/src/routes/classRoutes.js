...
import { addClass, addStudentToClass, addStudentToPool, classStudents, updateClass, assignCC, createStudent, resetStudentPassword, updateStudent, createSubject, getClassSubjects, assignFacultyToSubject, createAssessment, getSubjectClasses, getFacultyAssessments, getAssessmentMarks, updateAssessmentMarks, getStudentSubjects, getStudentSubjectPerformance, deleteUser, updateSubject, deleteSubject, updateAssessment, deleteAssessment } from "../controllers/classController.js";
...
router.patch('/subject/assign-faculty', auth, role("CC", "HOD"), assignFacultyToSubject);

// Assessment Routes
router.post('/assessment/create', auth, role("FACULTY", "CC", "HOD"), createAssessment);
router.get('/subject/:subjectId/classes', auth, role("FACULTY", "CC", "HOD"), getSubjectClasses);
router.get('/assessments/list', auth, role("FACULTY", "CC", "HOD"), getFacultyAssessments);
router.get('/assessment/:id/details', auth, role("FACULTY", "CC", "HOD"), getAssessmentMarks);
router.patch('/assessment/marks/update', auth, role("FACULTY", "CC", "HOD"), updateAssessmentMarks);

// Student Routes
router.get('/student/subjects', auth, role("STUDENT"), getStudentSubjects);
router.get('/student/subject/:subjectId/performance', auth, role("STUDENT"), getStudentSubjectPerformance);
...
router.patch('/assessment/update/:id', auth, role("HOD", "CC", "FACULTY"), updateAssessment);
router.delete('/assessment/delete/:id', auth, role("HOD", "CC", "FACULTY"), deleteAssessment);
